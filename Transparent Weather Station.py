...
canvas.pack()
bg_img = tk.PhotoImage(file="wall.gif")#file="C:/Users/bmg/Desktop/eh1.gif")
...
label_place = canvas.create_text((240,50), text=cityname, font=("Arial Bold", 45), fill="#652828")
label_temp = canvas.create_text((240,100), text=temp, font=("Arial Bold", 45), fill="#652828")
label_hum = canvas.create_text((240,150), text=hum, font=("Arial Bold", 45), fill="#652828")
label_press = canvas.create_text((240,200), text=press, font=("Arial Bold", 45), fill="#652828")

label0_time = canvas.create_text((100,260), text="Time", font=("Arial Bold", 15), fill="#652828")
label_time = canvas.create_text((100,290), text=current_time, font=("Arial Bold", 25), fill="#652828")

label0_date = canvas.create_text((350,260), text="Date", font=("Arial Bold", 15), fill="#652828")
label_date = canvas.create_text((350,290), text=current_date, font=("Arial Bold", 25), fill="#652828")
